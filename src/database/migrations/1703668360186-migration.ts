...
export class Migration1703668360186 implements MigrationInterface {
  name = 'Migration1703668360186';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE 
      "base_model" ("id" BIGSERIAL NOT NULL, 
      "status" smallint NOT NULL DEFAULT '1', 
      "createAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, 
      "updateAt" TIMESTAMP DEFAULT now(), CONSTRAINT 
      "PK_6858b0bfee6d486b76e323b3e9b" PRIMARY KEY ("id")); COMMENT ON COLUMN 
    ...
    await queryRunner.query(
      `CREATE TABLE 
      "notification" ("id" BIGSERIAL NOT NULL, 
      "status" smallint NOT NULL DEFAULT '1', 
      "createAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, 
      ...
      "PK_705b6c7cdf9b2c2ff7ac7872cb7" PRIMARY KEY ("id")); COMMENT ON COLUMN 
    ...
    await queryRunner.query(
      ...
      "notification" ("redirect_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX 
      "IDX_2bcdb87dc74b6ded01c685068a" ON 
      "notification" ("redirect_type") `,
    );
    await queryRunner.query(
      `CREATE INDEX 
    ...
    await queryRunner.query(
      `CREATE TABLE 
      "notification_member" ("notification_id" bigint NOT NULL, 
      ...
      "deleted_at" TIMESTAMP, CONSTRAINT 
      "PK_4b810225964c5c05ee4ba9df572" PRIMARY KEY ("notification_id", 
      "member_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX 
      "IDX_cb4c97a9fb681dffbab667a381" ON 
      "notification_member" ("notification_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX 
      "IDX_7f54c7fbfd93ce1a813a577d59" ON 
      "notification_member" ("member_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX 
      "IDX_9171a018eefba6b3d13cecc531" ON 
      "notification_member" ("is_read") `,
    );
    await queryRunner.query(
      `CREATE INDEX 
      "IDX_436946491934c9ef01d7e65270" ON 
      "notification_member" ("status") `,
    );
    await queryRunner.query(
      `CREATE TABLE 
      "verification_code" 
      ...
      "retry_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, 
      "update_at" TIMESTAMP NOT NULL DEFAULT now(), 
      "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT 
      "PK_d702c086da466e5d25974512d46" PRIMARY KEY ("id")); COMMENT ON COLUMN 
    ...
    await queryRunner.query(
      ...
      "password" character varying(255) NULL, CONSTRAINT 
      "UQ_d73619f5e63108e8d57e8e1859d" UNIQUE ("phone"), CONSTRAINT 
      "PK_97cbbe986ce9d14ca5894fdc072" PRIMARY KEY ("id")); COMMENT ON COLUMN 
      "member"."status" IS '0:Inactive, 1: Active, 2:Pending'; COMMENT ON COLUMN 
      "member"."name" IS 'FullName or name'; COMMENT ON COLUMN 
      ...
      "member"."is_super_admin" IS '1: Active, 0:A Active'; COMMENT ON COLUMN 
      "member"."role_id" IS 'Role for admin'`,
    );
    await queryRunner.query(
      `CREATE INDEX 
